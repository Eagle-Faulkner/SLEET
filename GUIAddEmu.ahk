...
Gui, 4: Add, Text, xp yp+25, Minimal commands needed prior to loading the emulator:
Gui, 4: Add, Edit, xp yp+25 w300 vNewEmuCMD2 gUpdateNewFullCommandDisplayer, 

Gui, 4: Add, Text, xp yp+25, Command needed to load the emulator:
Gui, 4: Add, Edit, xp yp+25 w300 vNewEmuCMDLoad gUpdateNewFullCommandDisplayer, 

Gui, 4: Add, Text, xp yp+25, Minimal commands needed after loading the emulator:
